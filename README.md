...
## Расширяемость и исключение ошибок
  - использование агрегации ошибок и отдельного класса дают возможность расширять отображение/логирование ошибок
  - Строгая типизиция запросов позволяет исключать ошибки на этапе неверных запросов
